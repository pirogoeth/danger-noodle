...
public class Parser {
    ...
    void debugStatement() throws IOException, errorCatch {
        String dType = scan.getNext();
        String dFlag = scan.getNext();
        boolean flag = false;

        switch (dFlag.toLowerCase()) {
            case "on":
                flag = true;
                break;
            case "off":
            ...
            default:
                throw new errorCatch(
                        "Bad error mode flag: " + dFlag
                        );
        }

        switch (dType) {
            case "Token":
                this.debug.bShowToken = flag;
                break;
            case "Expr":
                this.debug.bShowExpr = flag;
                break;
            case "Assign":
                this.debug.bShowAssign = flag;
                break;
            default:
                throw new errorCatch(
                        "Bad debugging mode: " + dType
                        );
        }
